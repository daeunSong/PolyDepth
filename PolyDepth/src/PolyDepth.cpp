								 ...
								 int grid_resolution) 
{
	...
	// \B3\B2\BE\C6\C0ִ\C2 configuration \B5\E9 \BB\E7\C0\CC\C0\C7 \BA񱳸\A6 \C5\EB\C7\D1 \C1\A6\B0\C5
	// \B5\CE \B0\B3\C0\C7 configuration \C0\C7 \B0Ÿ\AE\B0\AA \C1\DF ū \B0\CD\C0\CC \B5\CE configuration \BB\E7\C0\CC\C0\C7 \B0Ÿ\AE\B0\AA\BA\B8\B4\D9 ũ\B8\E9 \B0Ÿ\AE\B0\AA\C0\CC \C0\DB\C0\BA configuration\C0\BB \C1\A6\B0\C5\C7Ѵ\D9
	...
	// AABB\C0\C7 8\B0\B3 \B2\C0\C1\F6\C1\A1 \B1\D9ó\BF\A1 \C0ִ\C2 configuration\B5\E9\C0\BB \C1\A6\B0\C5\C7Ѵ\D9
	for (j = 0; j < ifconf.size(); j++)
	{
		if(ifcfac[j]) {
